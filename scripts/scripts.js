let weather = {
    apiKey: "335693caab24c80dc3e31365307b3f55",
    fetchWeather: function (city) {
        ...
        .then((data) => {
            ...
            // Calculate and display current time of the searched city
    ...
    displayWeather: function (data) {
        ...
        // Manipulating weather description array
        const weatherDescriptions = data.weather.map(weather => weather.description);
        const formattedDescriptions = weatherDescriptions.join(', '); // Joining descriptions with comma
